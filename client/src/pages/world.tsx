...
const BUILDINGS: BuildingDef[] = [
  ...
  {
    id: "fract-terminal", name: "FRACT TERMINAL", subtitle: "Offline",
    col: 3, row: 7, height: 4, palette: "plague", comingSoon: true,
    lore: "Terminal node for the FRACT network. Connection pending — patch not yet deployed.",
    href: null,
  },
  {
    id: "wireline-terminal", name: "WIRELINE TERMINAL", subtitle: "Offline",
    col: 6, row: 8, height: 3, palette: "noir", comingSoon: true,
    lore: "A hardwired access point. The line is live but the other end hasn't answered yet.",
    href: null,
  },
  {
    id: "hidden-himalayas", name: "HIDDEN HIMALAYAS", subtitle: "Locked",
    col: 12, row: 8, height: 5, palette: "blue", locked: true,
    lore: "Patch not yet deployed. Signal buried beneath the mountain. Location data encrypted.",
    href: null,
  },
  {
    id: "fractured-godhead", name: "FRACTURED GODHEAD", subtitle: "Under Construction",
    col: 7, row: 8, height: 6, palette: "crimson", locked: true,
    lore: "World status: under construction. Mythology loading. ETA classified.",
    href: null,
  },
];
